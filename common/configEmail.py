...
if __name__ == '__main__':
    m = SendMail(
        username='1329557725@qq.com',
        password='omcxtygdriapfjdb',
        recv=['13882618810@163.com'],
        title='发送邮件20180205',
        content='测试发送邮件，qq发件，接收方一个是163邮箱',
        file=r'D:\OpenApitest\OpenApi_test\result\20200716154631\output.log',
        ssl=True,
    )
    m.send_mail()
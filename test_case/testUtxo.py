...
utxo_xls = common.get_xls('OpenApiCase.xlsx','utxo')
localReadConfig = readConfig.ReadConfig()
configHttp = configHttp.ConfigHttp()
info = {}


@paramunittest.parametrized(*utxo_xls)
class utxo(unittest.TestCase):
    ...
    def testUtxo(self):
        # set url
        self.url = common.get_url_from_xml('utxo')
